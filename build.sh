...
cp "./BeatmapExporterCLI/bin/Release/net9.0/osx-x64/publish/BeatmapExporterCLI" "BuildOutput/mac-BeatmapExporterCLI-x86_64"
cp "./BeatmapExporterCLI/bin/Release/net9.0/osx-arm64/publish/BeatmapExporterCLI" "BuildOutput/mac-BeatmapExporterCLI-arm64"
...
tar -avcf "mac-BeatmapExporter_arm64.zip" "arm64-BeatmapExporter.app" --transform 's/arm64-//'
