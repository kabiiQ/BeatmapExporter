namespace BeatmapExporterCore.Utilities
{
    ...
    {
        public const string Version = "2.0.0"; // raw version, user is notified if their version is different than the online latest
        public const string FeatureVersion = "2.1.0-pre2";
